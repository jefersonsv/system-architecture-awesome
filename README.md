...
## Configuration
* [FappSettings](https://github.com/Jeern/FappSettings) - Provides an easy way to get .NET AppSettings from app.config or web.config using a dynamic func
...
* [Ensure.That](https://github.com/danielwertheim/Ensure.That) - Yet another guard clause project for .Net 

## Scrap
* [SpiderSharp](https://github.com/jefersonsv/SpiderSharp) - Web Crawling and Scraping Framework

## Web Server
* [Thunder](https://github.com/jefersonsv/Thunder) - Where productivity and performance go together
...
* [Octopus Deploy](https://octopus.com/) - Complex deployments, made easy

## Utils
* [Curl Builder](https://github.com/jefersonsv/curl-builder) - Generator curl command line from request
* [mongo-to-elastic](https://github.com/jefersonsv/mongo-to-elastic) - Sync from Mongodb to Elasticsearch database
* [Proxy at work](https://github.com/jefersonsv/proxy-at-work) - Configure proxy settings such as: environment variables, windows registry and configuration files easilly
* [NuspecFromGithub](https://github.com/jefersonsv/NuspecFromGithub) - Utility to create .nuspec file from github and project assembly
* [AssemblyInfoReader](https://github.com/jefersonsv/AssemblyInfoReader) - Read and parse the AssemblyInfo of any dotnet binary file
* [ConfigContrib](https://github.com/jefersonsv/ConfigContrib) - Simple and easy configuration reader
* [table2enum](https://github.com/jefersonsv/table2enum) - Create enum from any SQL Server table
* [m3uParser](https://github.com/jefersonsv/m3uParser) - A dotnet parser for M3U file format
...
* [MaterialDesignInXamlToolkit](https://github.com/ButchersBoy/MaterialDesignInXamlToolkit) - Toolkit for creating Material Design styled WPF apps
...
* [UWP Community Toolkit](https://github.com/Microsoft/WindowsCommunityToolkit) - The UWP Community Toolkit is a collection of helper functions, custom controls, and app services. It simplifies and demonstrates common developer tasks building UWP apps for Windows 10.
